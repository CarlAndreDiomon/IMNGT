        ...
        <main className="flex flex-col h-screen w-2/12 p-4 bg-[#fcfcbf] text-black">
            <header className="flex-1">
                ...
                <section className="relative mt-80 grid gap-10 ">
                    ...
                    <button><a href="" className="block w-full text-left text-3xl font-semibold hover:shadow-inner hover:shadow-gray-700 p-3 rounded-3xl transition duration-300">Products</a></button>
                    <button><a href="" className="block w-full text-left text-3xl font-semibold hover:shadow-inner hover:shadow-gray-700 p-3 rounded-3xl transition duration-300">Items</a></button>
                </section>
            </header>
